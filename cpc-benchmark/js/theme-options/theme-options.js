...
// -------------------------------------------------------------------------------------------------------------------------------
  ...
  $(document).ready(function($) {
    ...
    // Skin value
    var skin = "hp"; // // blue, bone, brown, cyan, green, orange, orange-light, purple, red, yellow 
	...
	$(".orange-light").click(function(){
   	...
   	$(".blue").click(function(){
        ...
        return false;
   		...
   		$(".hp").click(function(){
        $(".skin").attr("href", "css/skins/hp/hp.css");
	   	$(".logo").attr("src", "css/skins/hp/logo.png");
	   	$(".logo_big").attr("src", "css/skins/hp/logo-big.png");
        return false;
   	});
 });
